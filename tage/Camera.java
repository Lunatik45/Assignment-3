...
public class Camera
{
	...
	/**
	 * Pitch the camera by a specified angle relative to its U axis.
	 * 
	 * @param angle The angle to rotate v and n by.
	...
	/**
	 * Roll the camera by a specified angle relative to its N axis.
	 * 
	 * @param angle The angle to rotate u and v by.
	 * @author Eric Rodriguez
	 */
	...
	/**
	 * Yaw the camera by a specified angle relative to its V axis.
	 * 
	 * @param angle The angle to rotate u and n by.
	 * @author Eric Rodriguez
	 */
	...
	/**
	 * Yaw the camera by a specified angle relative to the worlds Up axis.
	 * 
	 * @param angle The angle to rotate u, v, and n by.
	 * @author Eric Rodriguez
	 */
	public void worldYaw(float angle)
	{
		u.rotateAxis(angle, defaultV.x(), defaultV.y(), defaultV.z());
		v.rotateAxis(angle, defaultV.x(), defaultV.y(), defaultV.z());
		n.rotateAxis(angle, defaultV.x(), defaultV.y(), defaultV.z());
	}
}