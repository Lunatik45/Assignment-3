 ...
 * </ul>
 * <p>
 * Each GameObject typically is associated with one TextureImage. More than one
 * GameObject can use the same TextureImage. All texture images must be read in
 * during init(). However, assignments of texture images to game objects can be
 * made or changed later.
 * 
 * @author Scott Gordon
 */
public class TextureImage {
	...
	/** for engine use */
	public void setTextureFile(String t)
	{
		textureFile = t;
	}
